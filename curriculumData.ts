...
export const CURRICULUM_DATA: CurriculumDB = {
  '康軒': {
    ...
    '三年級': {
      '上': [
        ...
        { id: 'k3u5', title: '5. 分數', subChapters: ['同分母分數加法', '同分母分數大小比較'] }
      ],
      '下': [
        ...
        { id: 'k3d4', title: '4. 圓與角', subChapters: ['認識圓', '認識角', '角的大小比較'] }
      ]
    },
    '四年級': {
      '上': [
        ...
        { id: 'k4u4', title: '4. 公里', subChapters: ['公公里的認識', '公里的換算與計算'] },
    ...
    '五年級': {
      ...
      '下': [
        ...
        { id: 'k5d2', title: '2. 容積', subChapters: ['認識公升與毫升', '長方體容積'] },
  ...
  '南一': {
    '一年級': {
      ...
      '下': [
        { id: 'n1d1', title: '1. 10以內加減', subChapters: ['加法', '減法'] }
      ]
    },
    '二年級': { '上': [], '下': [] },
    '三年級': { '上': [], '下': [] },
...
export const getLocalChapters = (publisher: Publisher, grade: Grade, semester: Semester): Chapter[] => {
  ...
  // 如果該版本沒有資料，嘗試抓康軒的作為替代（因為台灣教材大同小異）
  ...
  return [
    { id: 'f1', title: '1. 整數基礎', subChapters: ['整數加法', '整數減法'] },
    { id: 'f2', title: '2. 分數概念', subChapters: ['認識分數', '等值分數'] },
    { id: 'f3', title: '3. 幾何初步', subChapters: ['認識形狀', '周長計算'] },
    { id: 'f4', title: '4. 時間與測量', subChapters: ['時間的計算', '長度換算'] }
  ];
};
